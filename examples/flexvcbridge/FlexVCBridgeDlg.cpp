...
BOOL CFlexVCBridgeDlg::OnInitDialog()
{
    ...
    CASWorkSample* oSample = new CASWorkSample();
    CBridgeManager::RegisterDefaultCallbacks(oSample, 0);
    
    CASWorkSample2* oSample1 = new CASWorkSample2();
    CBridgeManager::RegisterDefaultCallbacks(oSample1, 1);
...
void CFlexVCBridgeDlg::FlashCallShockwaveflash2(LPCTSTR request)
{
    static int iFlashID = -1;
    
    if ( iFlashID == -1 )
        iFlashID = CFlashIDManager::GetIDFlashPtr((void*)&m_Shockwave2);
